...
open class signInDataTypeReactiveObject : signInDataType, IUTSReactive<signInDataType> {
    ...
    constructor(__v_raw: signInDataType, __v_isReadonly: Boolean, __v_isShallow: Boolean) : super(icon = __v_raw.icon, text = __v_raw.text) {
    ...
    override var icon: String
        get() {
            return trackReactiveGet(__v_raw, "icon", __v_raw.icon);
        }
        set(value) {
    ...
    override var text: String
        get() {
            return trackReactiveGet(__v_raw, "text", __v_raw.text);
        }
        set(value) {
...
open class TloginInfoReactiveObject : TloginInfo, IUTSReactive<TloginInfo> {
    ...
    override var __v_isReadonly: Boolean;
    override var __v_isShallow: Boolean;
    constructor(__v_raw: TloginInfo, __v_isReadonly: Boolean, __v_isShallow: Boolean) : super(username = __v_raw.username, password = __v_raw.password) {
        this.__v_raw = __v_raw;
        this.__v_isReadonly = __v_isReadonly;
        this.__v_isShallow = __v_isShallow;
    }
...
val __uniTabBar: Map<String, Any?>? = utsMapOf("color" to "#323232", "selectedColor" to "#b19983", "backgroundColor" to "#fff", "borderStyle" to "#fff", "iconWidth" to "28px", "fontSize" to "12px", "height" to "60px", "list" to utsArrayOf(
    utsMapOf("pagePath" to "pages/showWindow/showWindow", "text" to "展架", "iconPath" to "static/image/icons/未选择1.png", "selectedIconPath" to "static/image/icons/选择1.png"),
    utsMapOf("pagePath" to "pages/community/community", "text" to "集市", "iconPath" to "static/image/icons/未选择2.png", "selectedIconPath" to "static/image/icons/选择2.png"),
    utsMapOf("pagePath" to "pages/index/index", "text" to "药材", "iconPath" to "static/image/icons/未选择3.png", "selectedIconPath" to "static/image/icons/选择3.png"),
    utsMapOf("pagePath" to "pages/message/message", "text" to "养生", "iconPath" to "static/image/icons/未选择4.png", "selectedIconPath" to "static/image/icons/选择4.png"),
    utsMapOf("pagePath" to "pages/myPage/myPage", "text" to "我的", "iconPath" to "static/image/icons/未选择5.png", "selectedIconPath" to "static/image/icons/选择5.png")
));
