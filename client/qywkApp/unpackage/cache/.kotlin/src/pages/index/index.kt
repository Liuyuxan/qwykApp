...
open class GenPagesIndexIndex : BasePage {
    ...
    open var functionList: UTSArray<functionListType1> by `$data`;
    open var signInScrollToTop: Number by `$data`;
    open var signInData: UTSArray<signInDataType1> by `$data`;
    open var gandeplants: UTSArray<gandeplantType1> by `$data`;
    @Suppress("USELESS_CAST")
    override fun data(): Map<String, Any?> {
        return utsMapOf("plantTitle" to "人参" as String, "level" to 2 as Number, "schedule" to 25 as Number, "username" to "初心平原" as String, "challengeDays" to 2 as Number, "treeHeight" to 5 as Number, "currentPercenter" to 20 as Number, "functionList" to utsArrayOf<functionListType1>(functionListType1(icon = "/static/image/icons/plan.png", navgiateUrl = "", text = "计划"), functionListType1(icon = "/static/image/icons/clothes.png", navgiateUrl = "", text = "装扮"), functionListType1(icon = "/static/image/icons/message.png", navgiateUrl = "", text = "对话")), "signInScrollToTop" to 67, "signInData" to utsArrayOf<signInDataType1>(signInDataType1(icon = "/static/image/icons/money/money-box.png", text = "第七天：未知的惊喜", isSignIn = false, currentSignIn = false), signInDataType1(icon = "/static/image/icons/money/money-chinese.png", text = "第六天：中国结*2", isSignIn = false, currentSignIn = false), signInDataType1(icon = "/static/image/icons/money/money.png", text = "第五天：铜钱*4", isSignIn = false, currentSignIn = false), signInDataType1(icon = "/static/image/icons/money/money.png", text = "第四天：铜钱*3", isSignIn = true, currentSignIn = true), signInDataType1(icon = "/static/image/icons/money/money-box.png", text = "第三天：未知的惊喜", isSignIn = true, currentSignIn = false), signInDataType1(icon = "/static/image/icons/money/money-chinese.png", text = "第二天：中国结*1", isSignIn = true, currentSignIn = false), signInDataType1(icon = "/static/image/icons/money/money.png", text = "第一天：铜钱*2", isSignIn = true, currentSignIn = false)), "gandeplants" to utsArrayOf<gandeplantType1>(gandeplantType1(plant = "/static/image/plant/pot.png"), gandeplantType1(plant = "/static/image/plant/garden-plant.png"), gandeplantType1(plant = "/static/image/plant/pot.png")));
    }
    override fun `$initMethods`() {
        this.clickFunction = fun(item: functionListType1) {
            uni_navigateTo(NavigateToOptions(url = item.navgiateUrl));
        }
        ;
    }
    open lateinit var clickFunction: (item: functionListType1) -> Unit;
    companion object {
