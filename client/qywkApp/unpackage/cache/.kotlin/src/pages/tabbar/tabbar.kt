...
open class GenPagesTabbarTabbar : BasePage {
    ...
    override fun `$initMethods`() {
        ...
        this.handlerTouchstart = fun() {
            this.loop = setTimeout(fun(){
                this.loop = 0;
                console.log("长按", " at pages/tabbar/tabbar.uvue:122");
        ...
        this.handlerTouchend = fun() {
            clearTimeout(this.loop);
            if (this.loop !== 0) {
                console.log("单击", " at pages/tabbar/tabbar.uvue:139");
                if (this.centerIndex === true) {
                    return;
                }
                this.centerIndex = true;
                this.tabIndex = 2;
                console.log(this.tabIndex, this.centerIndex, " at pages/tabbar/tabbar.uvue:144");
                this.clickShow = true;
        ...
        this.tabChange = fun(index: Number) {
            ...
            this.tabIndex = index;
            console.log(index, this.tabIndex, " at pages/tabbar/tabbar.uvue:153");
        }
        ;
    }
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("center-img" to padStyleMapOf(utsMapOf("width" to 40)), "tabbar" to padStyleMapOf(utsMapOf("position" to "fixed", "zIndex" to 1000, "bottom" to 0, "left" to 0, "right" to 0, "backgroundColor" to "#ffffff", "width" to "100%", "height" to "7%", "overflow" to "visible", "display" to "flex", "flexDirection" to "row", "justifyContent" to "space-around", "alignItems" to "center")), "tab-item" to utsMapOf(".tabbar " to utsMapOf("width" to "20%", "height" to "100%", "overflow" to "visible", "display" to "flex", "flexDirection" to "column", "justifyContent" to "center", "alignItems" to "center", "transitionDuration" to "2s", "transitionTimingFunction" to "ease")), "bg-img" to utsMapOf(".tabbar .tab-item " to utsMapOf("width" to 70, "height" to 70, "borderRadius" to 70, "backgroundColor" to "#f2eee9", "display" to "flex", "justifyContent" to "center", "alignItems" to "center", "position" to "absolute", "bottom" to 16)), "center-icon" to utsMapOf(".tabbar .tab-item .bg-img " to utsMapOf("width" to 52)), "tab-icon" to utsMapOf(".tabbar .tab-item " to utsMapOf("width" to 24)), "tab-text" to utsMapOf(".tabbar .tab-item " to utsMapOf("fontSize" to 12, "color" to "#808080")), "active-text" to utsMapOf(".tabbar .tab-item " to utsMapOf("color" to "#937152")), "@TRANSITION" to utsMapOf("tab-item" to utsMapOf("duration" to "2s", "timingFunction" to "ease")));
            }
