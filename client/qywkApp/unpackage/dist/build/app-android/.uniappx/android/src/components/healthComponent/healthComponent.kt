...
open class GenComponentsHealthComponentHealthComponent : VueComponent {
    constructor(instance: ComponentInternalInstance) : super(instance) {}
    @Suppress("UNUSED_PARAMETER", "UNUSED_VARIABLE")
    override fun `$render`(): Any? {
        val _ctx = this;
        val _cache = this.`$`.renderCache;
        return createElementVNode("scroll-view", utsMapOf("direction" to "vertical", "class" to "health"), utsArrayOf(
            createElementVNode("image", utsMapOf("class" to "title fixed", "style" to normalizeStyle(utsMapOf("top" to "5%", "left" to "5%")), "src" to "/static/image/health/title.png", "mode" to "widthFix"), null, 4),
            createElementVNode("view", utsMapOf("class" to "link fixed", "style" to normalizeStyle(utsMapOf("top" to "-20%", "right" to "-22%")), "onClick" to _ctx.clickOption), utsArrayOf(
            ...
            createElementVNode("view", utsMapOf("class" to "link fixed", "style" to normalizeStyle(utsMapOf("top" to "-16%", "left" to "-30%")), "onClick" to _ctx.clickOption), utsArrayOf(
            ...
            createElementVNode("view", utsMapOf("class" to "link fixed", "style" to normalizeStyle(utsMapOf("top" to "-30%", "left" to "30%")), "onClick" to _ctx.clickOption), utsArrayOf(
