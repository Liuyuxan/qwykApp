...
open class GenPagesValidateCodeValidateCode : BasePage {
    ...
    override fun `$initMethods`() {
        this.clickRegiter = fun() {
            ...
            console.log(this.numberPhone, " at pages/validateCode/validateCode.uvue:17");
            uni_request<IResponse<ICode>>(RequestOptions(url = BASE_URL + ("/user/login/sent/code?tel=" + this.numberPhone), method = "POST", success = fun(res){
                var r = res.data;
                console.log("验证码返回信息", r, " at pages/validateCode/validateCode.uvue:24");
                if (r!!.code == 200) {
                    var code = r!!.data!!.code;
                    console.log(code, " at pages/validateCode/validateCode.uvue:27");
            ...
            , fail = fun(err){
                console.log(err, " at pages/validateCode/validateCode.uvue:44");
