package com.qywk.common.core.utils.sensitivewdfilter;
...
public class WordFilter {
	...
	private static final Map<Integer, WordNode> nodes = new HashMap<Integer, WordNode>(65535, 1); // 存储节点
	...
	private static List<String> readWordFromFile(String path) {
		...
		try {
			...
			words = new ArrayList<String>(12000);
